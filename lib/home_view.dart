        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              subHeader('Flutter', getFontSize(false)),
              SizedBox(height: screenHeight * 0.01,),
              subHeader('Android', getFontSize(false)),
              SizedBox(height: screenHeight * 0.01,),
              subHeader('Music', getFontSize(false)),
  ...
  Widget mobileView() {
    return Column(
      children: [
        ...
        header(30),
        SizedBox(height: screenHeight * 0.01,),
        subHeader('Flutter - Android - Music', 15)
      ],
    );
  }
  ...
  Widget header(double fontSize) {
    return RichText(
        text: TextSpan(
          ...
          TextSpan(text: 'Plinio', style: TextStyle(color: Color(0xff21a179))),
          TextSpan(text: '!')
        ]));
  }
  ...
  Widget picture() {
    return Container(
        ...
        child: ClipRRect(
            ...
            child: Image.asset('assets/picture.jpeg', fit: BoxFit.cover)));
  }
}
